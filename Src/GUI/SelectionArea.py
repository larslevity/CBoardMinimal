...
#                    print "(%s, %s) is in keylist" % (abszisse, ordinate)
    ...
    def __init__(self, data):
        ...
        *Initialize with:*
        ...
        p_btn = Gtk.Button()
        image = Gtk.Image()
        image.set_from_file("Src/GUI/pictures/pressure.png")
        p_btn.add(image)
        p_btn.connect("clicked", self.keylist_append, 'acc')
        ...
        alpha_btn.add(image)
        alpha_btn.connect("clicked", self.keylist_append, 'aIMU')
        ...
        eps_btn.add(image)
        eps_btn.connect("clicked", self.keylist_append, 'gyr')
